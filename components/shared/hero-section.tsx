    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-start justify-center h-full text-white px-6 md:px-20 lg:px-32">
        <h1 className="text-lg md:text-6xl font-extrabold mb-4 leading-tight tracking-wide">
          Empowering <span className="text-red-c2">Ideas</span>,
        </h1><br/>
        <h1 className="text-lg md:text-6xl font-extrabold mb-4 leading-tight tracking-wide">
        Igniting Change  
        </h1>
        <p className="md:text-2xl mb-8 font-semibold">
          Nepal<span className="text-red-c2">'</span>s Biggest <span className="text-red-c2">TEDx</span> Event Happening Soon.
        </p>

       <br />
        <div className="flex space-x-4">
          <button className="bg-red-c2 hover:bg-red-c1 text-white font-bold py-3 px-20 rounded-md shadow-lg text-xl">
            Explore More
          </button>
