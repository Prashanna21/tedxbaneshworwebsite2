...
const Navbar = () => {
  ...
  return (
    <nav className="bg-slate-950 w-full fixed z-50 left-0 right-0 top-0 h-[64px]">
      <div className="px-6 md:px-8 py-2 md:py-0 flex mx-auto items-center md:max-w-[1400px] h-full">
        <Link href="/">
        ...
        <div className="ml-auto flex gap-16 items-center h-full">
      ...
      >
        <div className="pb-5">
          <div className="flex flex-col space-y-5 items-center ">
            {NAV_LINKS_EXAMPLE?.map((navLink) => (
             <label key={navLink.id} onClick={closeMenu}> <NavLink key={navLink.id} {...navLink} /> </label>
            ))}
