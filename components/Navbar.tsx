    ...
    <nav className="bg-slate-950 w-full fixed z-50 left-0 right-0">
          ...
          <div className="hidden md:flex space-x-10 items-center">
            ...
            >
              <label className="flex items-center text-white text-sm hover:text-red-600 cursor-pointer">
                Explore
                 <IoMdArrowDropdown className={`text-[#726A6A] ml-[-1px] ${exploreDropdownActive ? "rotate-180 transition-transform duration-300 ease-in-out": ""}`} />
              </label>
              <ul
            ...
            >
              <label className="flex items-center text-white text-sm hover:text-red-600 cursor-pointer">
                About Us
                 <IoMdArrowDropdown className={`text-[#726A6A] ml-[-1px] ${aboutDropdownActive ? "rotate-180 transition-transform duration-300 ease-in-out": ""}`} />
              </label>
      ...
      <div
              ...
              >
                ...
                <ul
                   className={`text-white ml-20 transform transition-all duration-500 ease-in-out shadow-[0_4px_8px_rgba(0,0,0,0.4)] ${exploreDropdownActive ? ' block' : 'hidden'}`}
            ...
            <div
              ...
              >
                ...
                <ul
                   className={`text-white ml-20 transform transition-all duration-500 ease-in-out shadow-[0_4px_8px_rgba(0,0,0,0.4)] ${aboutDropdownActive ? ' block' : 'hidden'}`}
